...
- If `pre-merge` or `review` fails, fix the issue and rerun the workflow; `scripts/merge/review.sh` prints the review failure details and writes `.crank/review-last.log`.
